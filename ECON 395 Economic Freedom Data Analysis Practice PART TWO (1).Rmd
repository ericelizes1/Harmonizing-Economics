...
summary(int_term)
```
From this regression, it is clear that a 1 point increase in the interaction between trade and regulation correlates with a -1.21 decrease in rank. As a result, a 1 point increase in trade and 1 point increase in regulation correlates with, respectively, a 9.20 and 10.91 increase in rank. These have statistically small p-values and are thus statistically significant. Economically, this is significant and implies that
