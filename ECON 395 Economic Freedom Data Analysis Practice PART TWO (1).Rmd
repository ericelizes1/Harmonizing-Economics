...
stargazer(simple_reg, multivar_reg, fixed_eff_est, int_term, multi_1, multi_2, log_lin, log_log,
          ...
          column.labels = c("SR", "MR", "FE", "IT", "MA1", "MA2", "Log-Lin", "Log-Log"))
```
...
stargazer(simple_reg, 
          ...
          font.size = "small",
          omit.stat=c("ser","f", "adj.rsq"),
          title = "Table 3: Simple Regression")
```
...
$$ \hat{rank} = b_0 + b_1 * government \ size + b_2 * property \ rights + b_3 * sound \ money + $$
$$ b_4 * trade + b_5 * regulation $$

The results of this regression are included below:

```{r, warning = FALSE, echo=FALSE, comment = NA}
stargazer(multivar_reg, 
          type = 'text',
          omit = 'country',
          no.space = TRUE,
          column.sep.width = "3pt",
          font.size = "small",
          omit.stat=c("ser","f", "adj.rsq"),
          title = "Table 4: Multivariate Regression")
```
...
$$ \hat{rank} = b_0 + b_1 * government \ size + b_2 * property \ rights + b_3 * sound \ money + $$
$$ b_4 * trade + b_5 * regulation + b_6 * country $$

The results of this regression are as follows:

```{r, warning = FALSE, echo=FALSE, comment = NA}
stargazer(fixed_eff_est, 
          type = 'text',
          omit = 'country',
          no.space = TRUE,
          column.sep.width = "3pt",
          font.size = "small",
          omit.stat=c("ser","f", "adj.rsq"),
          title = "Table 5: Fixed Effects Estimator")
```
...
$$ \hat{rank} = b_0 + b_1 * government \ size + b_2 * property \ rights + b_3 * sound \ money + $$
$$ b_4 * trade + b_5 * regulation + b_6 * country + b_7 * trade * regulation $$
...
stargazer(int_term, 
          ...
          font.size = "small",
          omit.stat=c("ser","f", "adj.rsq"),
          title = "Table 6: Multivariate Regression with Interaction Term")
```
...
$$ \hat{rank} = b_0 + b_1 * government \ size + b_2 * property \ rights + $$
$$ b_3 * trade + b_4 * regulation + b_5 * country $$

$$ \hat{rank} = b_0 + b_1 * government \ size + b_2 * property \ rights + $$
$$ b_3 * sound \ money + b_4 * regulation + b_5 * country $$
...
stargazer(multi_1, 
          ...
          font.size = "small",
          omit.stat=c("ser","f", "adj.rsq"),
          title = "Table 7: Multicollinearity Analysis Regression 1")
```
...
stargazer(multi_2, 
          ...
          font.size = "small",
          omit.stat=c("ser","f", "adj.rsq"),
          title = "Table 8: Multicollinearity Analysis Regression 2")
```
...
$$ log(\hat{rank}) = b_0 + b_1 * government \ size + b_2 * property \ rights + b_3 * sound \ money + $$
$$ b_4 * trade + b_5 * regulation + b_6 * country $$
...
stargazer(log_lin, 
          ...
          font.size = "small",
          omit.stat=c("ser","f", "adj.rsq"),
          title = "Table 9: Log-Linear Model")
```
...
$$ log(\hat{rank}) = b_0 + b_1 * log(government \ size) + b_2 * log(property \ rights) + b_3 * log(sound \ money) + $$
$$ b_4 * log(trade) + b_5 * log(regulation) + b_6 * country $$
